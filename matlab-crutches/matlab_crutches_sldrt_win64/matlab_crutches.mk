...
MAKECMD         = "D:/Matlab2019b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := matlab_crutches
MODULES              := matlab_crutches_data.c matlab_crutches_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := matlab_crutches.mk
MATLAB_ROOT          := D:/Matlab2019b
MATLAB_BIN           := D:/Matlab2019b/bin
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
SLDRTDIR             := D:/Matlab2019b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := matlab_crutches_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/Projects/uom-exoskeleton-force-reading/matlab-crutches;E:/Projects/uom-exoskeleton-force-reading/matlab-crutches/matlab_crutches_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
